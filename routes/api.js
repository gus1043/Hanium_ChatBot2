        ...
        messages: [
          {
            role: 'system',
            content:
              '사용자의 발화에 장치 제어 명령이 포함되어 있다면, 아직 학습되지 않은 문장입니다. 비슷한 문장으로 다시 시도해 주세요. 라고 출력해. 그 외의 문장에서는 다음과 같이 답하라: 당신은 모든 분야의 전문가이며, 대답이 정말 빠릅니다. 20대의 친근한 여성처럼 친절하게 대답해 주세요. (조건: 10초 이내로)',
          },
          {
            role: 'user',
            content:
              '내가 감기에 걸린 것 같아 목이 아파 방에 먼지가 많은 건가? 공기청정기 켜 줘',
          },
          {
            role: 'assistant',
            content:
